                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                sun_glass(), // Navigate to the CatalogScreen
                          ),
                        );
                      },
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => mans(), // Navigate to the
                          ),
                        );
                      },
                      child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => dell()),
                      );
                    },
                    child: Container(
                      height: 200,
                      width: 200,
                      child: Image.asset('assets/images/d3.jpg'),
                    ),
                  ),
                  Column(
                    children: [
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      height: 200,
                      width: 200,
                      child: Image.asset('assets/images/d4.jpg'),
                    ),
                  ),
                  Column(
                    children: [
